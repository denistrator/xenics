import { Bell, BookOpen, Command, FolderGit2, Settings2 } from 'lucide-react'
    ...
    >
      <aside className="hidden border-r border-x-line bg-x-panel px-5 py-6 lg:flex lg:flex-col">
        <div className="mb-12 flex items-center gap-3">
          <span className="grid size-9 place-items-center rounded-xl bg-x-mint text-sm font-bold">X</span>
          <span className="font-display text-xl tracking-tight">Xenics</span>
        </div>

        <nav aria-label="Primary" className="space-y-2 text-sm">
          <a className="flex items-center gap-3 rounded-xl bg-x-mint px-3 py-3 font-semibold" href="#catalog">
            <BookOpen size={17} />
            Library
          </a>
          <a className="flex items-center gap-3 rounded-xl px-3 py-3 text-x-muted hover:bg-x-paper" href="#sources">
            <FolderGit2 size={17} />
            Sources
          </a>
          <a className="flex items-center gap-3 rounded-xl px-3 py-3 text-x-muted hover:bg-x-paper" href="#settings">
            <Settings2 size={17} />
            Settings
          </a>
        </nav>
