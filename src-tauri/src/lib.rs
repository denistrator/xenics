...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::organization::assign_bookmark_collection,
            commands::organization::assign_bookmark_tag,
            commands::organization::list_bookmark_collections,
            commands::organization::list_bookmark_tags,
