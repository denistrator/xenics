...
- Desktop acceptance now covers the notification panel, reset safety affordance, search-view entry, catalog filtering/details, and scheduled update selection; the existing macOS/native harness remains the verified platform path.
