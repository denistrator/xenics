...
- Catalog management now exposes native-backed update/remove actions for installed sources and an explicit Update all action; custom-source entry and bulk review remain to be completed.
